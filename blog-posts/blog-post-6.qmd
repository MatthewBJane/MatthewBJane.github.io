...
>  As can be seen the overall estimate for d across studies was 0.088, which was nonsignificant and well below the SESOI
(r = .10, d = 0.21). 
...
regplot(mdl_weeks, pi = T, refline = 0, ylab = "Effect Size (d)", xlab = "Length of Intervention in Weeks")
