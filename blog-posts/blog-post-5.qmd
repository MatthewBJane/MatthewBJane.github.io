...
Conditional expectation ($\mathbb{E}[\cdot]$) is the average observed score over all possible observed scores for a given person. This also provides the beautiful property that $X_{p}$ for a given person, is an \*calibrated\* to $T_p$, since,
