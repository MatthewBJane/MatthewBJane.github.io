...
code-fold: false
date: 2024-09-02
description: "I want to thank Jonathan Haidt and Zach Rausch for engaging with my [critique](https://matthewbjane.com/blog-posts/blog-post-6.html) of their re-analysis of Ferguson's meta-analysis. Unfortunately, their response continued to convey a misunderstanding of meta-analysis. There however were some valid points brought up that could have enhanced my analyses so I will also include those here. Before digging into this post, please first read my initial [critique](https://matthewbjane.com/blog-posts/blog-post-6.html). I also address some accusations about my motivation here."
categories:
  - meta-analysis
  - social media
...
I think this community note was not only fair but absolutely true is much more fair and captures the overall criticism I was making. After Haid
