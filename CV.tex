...
\tightlist
\item
  2023 \textbar{} \textbf{Artifact Corrections for Effect Sizes},
  \emph{by Matthew B. Jané}. An open-soucre book for correcting bias in
  effect size estimates contaminated by statistical artifacts. Includes
  applications meta-analysis and implementation in R.
\end{itemize}
